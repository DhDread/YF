...
{
    public partial class Mack_RHF : Form
    {
        ...
        public void Mack_RHF_Load(object sender, EventArgs e)
        {
        ...
        {
            RHF_Timer.Enabled = true;
            RHF_Timer.Start();
            RHF_Timer.Tick += new EventHandler(RHR_Timer_Tick);
        ...
        public void RHF_Fill_Data()
        {
            ...
            try
            {
                ...
                while (appli.Read())
                {
                    ...
                    this.App_Seq_Lbl.Text = seqlbl.Substring(seqlbl.Length - 4, 4) + " " + "(" + CT + ")";
                }
                appli.Close();
