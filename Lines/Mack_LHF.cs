...
{
    public partial class Mack_LHF : Form
    {
        ...
        private void Mack_LHF_Load(object sender, EventArgs e)
        {
        ...
        {
            LHF_Timer.Enabled = true;
            LHF_Timer.Start();
            LHF_Timer.Tick += new EventHandler(LHF_Timer_Tick);

        }
        void LHF_Timer_Tick(object sender, EventArgs e)
        {
            Fill_Data();
        }
