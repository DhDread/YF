...
{
    public partial class Jnap_RHF : Form
    {
        ...
        private void Jnap_RHF_Load(object sender, EventArgs e)
        {
        ...
        private void Timer_Stuff()
        {
            ...
            RHF_Timer.Start();
            RHF_Timer.Tick += new EventHandler(RHF_Timer_Tick);

        }
        void RHF_Timer_Tick(object sender, EventArgs e)
        {
            Fill_Data();
        }
