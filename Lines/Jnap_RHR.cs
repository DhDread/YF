...
{
    public partial class Jnap_RHR : Form
    {
        ...
        public Jnap_RHR()
        {
            ...
            this.WD_Armrest_Panel.MouseClick += WD_Armrest_Click; this.WD_Armrest_Lbl.MouseClick += WD_Armrest_Click; this.WD_Armrest_Seq_Lbl.MouseClick += WD_Armrest_Click;
        ...
        private void Jnap_RHR_Load(object sender, EventArgs e)
        {
        ...
        {
            RHR_Timer.Enabled = true;
            RHR_Timer.Start();
            RHR_Timer.Tick += new EventHandler(RHR_Timer_Tick);
        }
        void RHR_Timer_Tick(object sender, EventArgs e)
        {
            Fill_Data();
        }
